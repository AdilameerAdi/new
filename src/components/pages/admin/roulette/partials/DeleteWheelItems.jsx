...
export const DeleteWheelItems = ({ modal, setModal, items = {}, setItems }) => {

  const dispatch = useDispatch()

  const handleDelete = async () => {

    const url = `${apiConfig().endpoint}/wheel/remove/`
    ...
    >
        <div className="flex flex-col gap-4">
          ...
          <h5 className="text-xl text-center">
              Are you sure you want to delete {items.length} items from wheel?
          </h5>          
        </div>
