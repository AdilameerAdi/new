...
export const ResetAccountDailyShop = ({ modal, setModal, id }) => {

    const dispatch = useDispatch()

    const submit = async () => {

        const url = `${apiConfig().endpoint}/shop/daily/reset/${id}`
        ...
        >
            <div className="flex flex-col gap-4">
                ...
                <h5 className="text-xl text-center">
                    Are you sure you want to reset this account daily shop?
                </h5>
            </div>
