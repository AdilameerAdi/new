...
export const ResetWeeklyShop = ({ modal, setModal }) => {

  const dispatch = useDispatch()

  const submit = async () => {

    const url = `${apiConfig().endpoint}/shop/weekly/reset`
    ...
    >
      <div className="flex flex-col gap-4">
          ...
          <h5 className="text-xl text-center">
              Are you sure you want to reset weekly shop buys?
          </h5>
      </div>
